...
namespace DataGridViewPrinter
{
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("B Titr", 12, FontStyle.Bold, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("B Titr", 12, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("B Titr", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("B Titr", 12, FontStyle.Bold, GraphicsUnit.Point);
