...
/// <summary>
/// فارسی سازی و بومی سازی MessageBox موجود در تلریک 
/// طریقه استفاده:
/// System.Windows.Forms.RightToLeft rtl = System.Windows.Forms.RightToLeft.Yes;
/// Telerik.WinControls.RadMessageBox.Show(this, "Your Message", "Caption", MessageBoxButtons.OK, Telerik.WinControls.RadMessageIcon.Info, MessageBoxDefaultButton.Button1, rtl);
/// </summary>
public class MyRadMessageLocalizationProvider : RadMessageLocalizationProvider
{
    ...
    public override string GetLocalizedString(string id)
    {
        switch (id)
        {
            ...
            case RadMessageStringID.IgnoreButton: return "موافقم";
            case RadMessageStringID.NoButton: return "نه";
            case RadMessageStringID.OKButton: return "قبول";
            case RadMessageStringID.RetryButton: return "امتحان دوباره";
